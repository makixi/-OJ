...
void div1(int a, int b, int m, int n) {
    if (m == 0 && n == 0) cout << "error";
        ...
        if (l != 0) {
            if (r != 0) {
                if (r > 0) cout << setprecision(1) << l << "+" << r << endl;
                else cout << setprecision(1) << l  << r << "i" << endl;
            }
            else cout << setprecision(1) << l << endl;
        } else {
            if (r != 0) cout << setprecision(1) << r << "i" << endl;
            else cout << 0;
        }
    }
}
